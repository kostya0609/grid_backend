...
class CreateLGridsFilterPresetDefaultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('l_grids_filter_preset_defaults', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('l_grids_filter_preset_defaults');
    }
}
